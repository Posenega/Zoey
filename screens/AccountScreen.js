...
function AccountScreen(props) {
  ...
  const grade = useSelector((state) => state.auth.grade);
          ...
          <View style={styles.header}>
            ...
            <View>
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => {
                  return (
                    <View style={styles.areYouAStudentContainer}>
                      <Text style={styles.areYouAStudentText}>
                        Are you a student?
                      </Text>
...
const getStyles = (theme) =>
  StyleSheet.create({
    ...
    areYouAStudentText: { color: getThemeColor("text", theme) },
    header: {
      paddingTop: "10%",
      flex: 1,
      width: "100%",
